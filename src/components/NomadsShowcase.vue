  ...
  <section class="nomads-showcase-section">
    <div class="showcase-header">
      <div class="header-left">
        <h2 class="showcase-title">黄历宜忌与时光节点解读专家实战模板库</h2>
...
const showcaseItems = computed<ShowcaseItem[]>(() => [
  {
    id: 'ai-rili-1',
    tag: '商业开业',
    title: '店铺开业剪彩与签约黄金吉日择取',
    prompt: '查询本月适合科技公司开业与签署战略合作合同的 3 个吉日吉时。',
    usageCount: '54.5k'
  },
  {
    id: 'ai-rili-2',
    tag: '乔迁入宅',
    title: '搬家乔迁仪式顺路方位与注意事项',
    prompt: '择取搬家入宅吉日，安排先搬何物及开火安床的传统民俗仪式步骤。',
    usageCount: '48.9k'
  },
  {
    id: 'ai-rili-3',
    tag: '日常出行',
    title: '今日财神喜神方位与求财吉时',
    prompt: '查询今日财神喜神方位及商务谈判最佳时段，提供出行避雷建议。',
    usageCount: '42.3k'
  },
  {
    id: 'ai-rili-4',
    tag: '节气养生',
    title: '立秋节气饮膳调理与情绪养安',
    prompt: '结合立秋节气给出润肺防燥食谱、作息建议及精神调适指南。',
    usageCount: '37.8k'
  },
  {
    id: 'ai-rili-5',
    tag: '婚嫁祈福',
    title: '订婚领证吉日挑选与干支合婚',
    prompt: '根据两人生辰八字干支择取适合领证结婚的吉日，附带仪式祝福文案。',
    usageCount: '33.1k'
  },
  {
    id: 'ai-rili-6',
    tag: '高考开工',
    title: '重大项目开工拜山与旗开得胜',
    prompt: '为工程项目开工提供顺势仪式流程安排与吉祥方位指引。',
    usageCount: '29.4k'
  }
]);
