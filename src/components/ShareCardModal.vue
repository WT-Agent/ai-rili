    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">日历与黄历计划</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 智能择吉与每日黄历计划</span>
...
// 清理回复末尾的特殊标记 [RILI_SCORES]...[/RILI_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[RILI_SCORES\][\s\S]*?\[\/RILI_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 智能日历与黄历计划】\n\n${cleanContent.value}\n\n体验智能择吉时间管理：https://ai.wuxian.xyz`;
